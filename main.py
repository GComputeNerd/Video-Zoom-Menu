...
def zoomIn(clip, ogSize, croppedSize ,center=None, duration=10,
...
def zoomOut(clip, ogSize, croppedSize, center=None, duration=3
    ,       initial_duration = 2, final_duration = 2):
    total_duration = initial_duration+duration+final_duration

    clip = zoomIn(clip, ogSize, croppedSize, center=None,
...
zoomOut(clip1, ogSize, croppedSize).write_videofile("test1.mp4", fps=24)